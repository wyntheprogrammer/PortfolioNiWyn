...
const ProjectBox = ({ src, alt, style }) => {
    ...
    return (
        <div className="h-96 rounded-xl overflow-hidden group relative">
            ...
            <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 z-10">
                <button className="w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center cursor-pointer hover:text-white hover:scale-110 transition-transform  duration-300">
